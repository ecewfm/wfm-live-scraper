// File: lib/db-talkdesk.js
// Path: C:\Users\rodolfo.luga\Documents\Node Projects\wfm-live-scraper\lib\db-talkdesk.js
// lib/db-talkdesk.js
...
async function writeTalkdeskSnapshot(scraped, accountId) {
  ...
  if (scraped.agents && scraped.agents.length > 0) {
    ...
    await pruneDeparted('talkdesk_agent_states', accountId, new Set(agentRows.map(r => r.id)))
